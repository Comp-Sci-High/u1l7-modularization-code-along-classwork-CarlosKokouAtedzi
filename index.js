...
console.log(heroAction("aquaman", "fighting styles", "sea"))
console.log(heroAction("antman", "fighting styles", "nyc "))
...
function villainAction (villian, power, city){

    return villian + "has escaped from the Raft and is causing chaos in" + city + power
...
console.log(villainAction("doctor octo ", "time square", "destroyng en"))
...
function characters (secretIdentity, city, affiliation, archNemesis, catchphrase){
    return "Otherwise known as "+ secretIdentity + "An" + affiliation + "stationed"  + city + "He's known as " + secretIdentity + "his arch nemesis is" + archNemesis + "and his catchphrase is" + catchphrase
}
